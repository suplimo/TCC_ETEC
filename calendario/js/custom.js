...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function (info) {
            ...
            document.getElementById("visualizar_id_usuario").innerText = info.event.extendedProps.id_usuario;
            document.getElementById("visualizar_title").innerText = info.event.title;
            document.getElementById("visualizar_lab").innerText = info.event.extendedProps.lab;
            document.getElementById("visualizar_turma").innerText = info.event.extendedProps.turma;
            document.getElementById("visualizar_materia").innerText = info.event.extendedProps.materia;
            document.getElementById("visualizar_material").innerText = info.event.extendedProps.material;
            ...
            document.getElementById("edit_lab").value = info.event.extendedProps.lab;
            document.getElementById("edit_turma").value = info.event.extendedProps.turma;
            document.getElementById("edit_materia").value = info.event.extendedProps.materia;
            document.getElementById("edit_material").value = info.event.extendedProps.material;
        ...
        formEditEvento.addEventListener("submit", async (e) => {
            ...
            if (!resposta['status']) {
                ...
                if (eventoExiste) {
                    ...
                    eventoExiste.setProp('id_usuario', resposta['id_usuario']);
                    eventoExiste.setProp('color', resposta['color']);
                    eventoExiste.setExtendedProp('lab', resposta['lab']);
                    eventoExiste.setProp('turma', resposta['turma']);
                    eventoExiste.setProp('materia', resposta['materia']);
                    eventoExiste.setProp('material', resposta['material']);
    ...
    console.log(testuser_id);
    console.log(testemail);
    /*console.log(sessionStorage.getItem('id_usuario'), 'XXX', resposta[id_usuario]);
    if (sessionStorage.getItem('id_usuario') == resposta[id_usuario]){
        console.log(sessionStorage.getItem('id_usuario'), 'XXX', resposta[id_usuario]);
        btnApagarEvento.disabled = true;
    }else{
        console.log(sessionStorage.getItem('id_usuario'), 'XXX', resposta[id_usuario]);
        btnApagarEvento.disabled = false;
    }*/
